...
\draw[->] (16mm,10mm) node[right] {\p{suporte (na parte inferior do robô)}} -- (13mm,3mm);
\draw[->,thick] (20mm,0) -- node[below] {\p{avançar} } +(18mm,0);
