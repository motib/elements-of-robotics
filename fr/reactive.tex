...
\begin{quote}
\normalsize\noindent\textbf{Spécification (Indécis):}\index{Véhicule Braitenberg!indécis} Lorsque le robot ne détecte pas d'objet, il se déplace vers l'avant. Lorsqu'il détecte un objet, il recule.
\end{quote}
...
\begin{quote}
\normalsize\noindent\textbf{Spécification (Dogged):}\index{Véhicule Braitenberg!dogged} Lorsque le robot détecte un objet à l'avant, il recule. Lorsque le robot détecte un objet à l'arrière, il se déplace vers l'avant.
\end{quote}
\end{itemize}
\end{framed}
...
\begin{quote}
\normalsize\noindent\textbf{Spécification (Dogged (arrêt)):}\index{Véhicule Braitenberg!dogged} Comme dans Activity~\ref{act.dogged}, mais lorsqu'un objet n'est pas détecté, le robot s'arrête.
\end{quote}
\end{itemize}
\end{framed}
...
\begin{quote}
\normalsize\noindent\textbf{Spécification (Attraction et répulsion):}\index{Véhicule de Braitenberg!attractif et répulsif} Lorsqu'un objet s'approche du robot par derrière, le robot s'enfuit jusqu'à ce qu'il soit hors de portée.
\end{quote}
\end{itemize}
\end{framed}
...
\begin{framed}
\act{Ligne suiveuse avec un capteur}{line-following-two}
\begin{itemize}
